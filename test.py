...
profile = ShoppingProfile(
    ...
    actPassword="8290F9AF",
    shippingAddress=Address(
        address="6-23 Echovalley Dr",
        city="Stoney Creek",
        firstName="Anthony",
        lastName="Ma",
        phoneNumber="2893211931",
        province="ON",
        postalCode="L8J0K4",
    ),
    creditCard=CreditCard(
        firstName="Anthony",
        lastName="Ma",
        creditCardNumber="4537339753904016",
        cvv="414",
        expMonth="1",
        expYear="2022",
        type="VISA",
...
item = CanadaComputers(
    "https://www.canadacomputers.com/product_info.php?cPath=11_180_181&item_id=136484&sid=kv9lsjdtpa7shoh3mvsisgsen0"
)
